    ...
    navigation(
        ...
        composable(route = OnboardingRoutes.WELCOME1.route) {
            WelcomeScreen1(
                ...
                onSkip = {
                    navController.navigate(OnboardingRoutes.SIGN_IN.route)
                }
            )
        }
        ...
        composable(route = OnboardingRoutes.SIGN_IN.route) {
            SigninScreen(
                onSignInComplete = {
                ...
                onSignupClick = {
                    navController.navigate(OnboardingRoutes.SIGN_UP.route)
                },
                authViewModel = authViewModel
            )
        }

        composable(route = OnboardingRoutes.SIGN_UP.route) {
            SignupScreen(
...
sealed class OnboardingRoutes(val route: String) {
    ...
    data object SIGN_IN : OnboardingRoutes("sign_in")
    data object SIGN_UP : OnboardingRoutes("sign_up")

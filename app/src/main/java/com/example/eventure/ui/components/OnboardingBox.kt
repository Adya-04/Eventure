...
import com.example.eventure.ui.theme.BlueMainColor
import com.example.eventure.ui.theme.BottomCardShape
...
@Composable
fun OnboardingBox(title: String, description: String, imageRes : Int, nextTxt : String) {
    Card(
